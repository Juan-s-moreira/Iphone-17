...
const Colors = () => {
    ...
    const colors = [
        ...
        { id: 'orange', name: 'Titânio Laranaja', image: '/img/iphone-orange.jpg', colorClass: 'bg-orange-500' }
    ]

    const models = [
        { name: 'Pro Max', screen: '6.9 polegadas', storage: '256BG, 512Gb ou 1TB', battery: '33h de vídeo', weight: '221g' },
        { name: 'Pro', screen: '6.3 polegadas', storage: '128Gb, 256BG ou 512Gb', battery: '29h de vídeo', weight: '199g' }
    ]
    return (
        <section id='cores' className='bg-black py-20 px-8'>
            <div className='max-w-7xl mx-auto'>
                <div className='text-center mb-16'>
                    ...
                    <p className='text-gray-400'>Quatro acabementos em titânio lindos</p>
                </div>
            </div>
            ...
            <div className='flex justify-center flex-col mb-12'>
                <div className='relative w-full mx-auto max-w-3xl'>
                    <div className='relative flex items-center justify-center min-h-[500px]'>
                        <img src={colors.find(color => color.id === selectedColor).image} alt="iphone 17" className='max-w-full max-h-[600] mx-auto my-auto' />
                    </div>
                ...
                <div className='text-center mt-16'>
                    <button className='bg-blue-600 hover:bg-blue-800 text-white px-12 py-4 rounded-full text-lg font-medium transition-all duration-300 mb-8 hover:scale-105 shadow-md shadow-blue-500/50 cursor-pointer'>
                        Compre agora a partir de $9.950
                    </button>
                    <p className='text-gray-300'>Ou em 12x de $994.92 sem juros</p>
                </div>
