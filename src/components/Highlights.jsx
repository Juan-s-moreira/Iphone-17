        ...
        <section className='bg-black py-20 px-6' id='design'>
            <div className='max-w-7xl mx-auto'>
                <div className='text-center mb-16'>
                    <h2 className='text-5xl font-bold mb-4'>Deisgn revolucionário</h2>
                    <p className='text-xl text-gray-400'>Cada detalhe foi feito para criar a melhor experiência</p>
                </div>

                <div className='grid grid-cols-2 gap-8 mb-16'>
                    <div className='bg-gray-900 rounded-3xl p-8'>
                        <img src="/img/titanium-design.jpg" alt="iphone titanium" className='w-full rounded-2xl  mb-4' />
                        <h3 className='font-bold mb-2 text-3xl'>Titânio Preimium</h3>
                        <p className='text-gray-300'>Estrutura em titânio de grau aerospacial. O smarthphone mais forte e leve.</p>
                    </div>
                    <div className='bg-gray-900 rounded-3xl p-8'>
                        ...
                        <p className='text-gray-300'>O sistema operacional mais avançado do mundo dom IA integrada</p>
                    </div>
                </div>
                ...
                <div className='bg-gray-900 rounded-3xl p-12 mb-16' id='performance'>
                    ...
                    <img src="/img/chip-a18-pro.jpg" alt="chip-a18" className='w-full rounded-2xl mb-4' />

                    <ul className='space-y-3 text-gray-300'>
                        <li>CPu 20% mais Rápida</li>
                        <li>GPU 25% mais eficiente</li>
                        <li>Neural Engine com 16 núcleos</li>
                        <li>Ray tracing acelador por hardware</li>
                    </ul>
                </div>
                ...
                <div className='text-center' id='camera'>
                    ...
                    <div className='grid grid-cols-3 gap-6'>
                        ...
                        <div className='bg-gray-900 rounded-2xl p-8 hover:scale-105 cursor-pointer transition-all duration-300'>
                            ...
                            <p className='text-gray-400'>Campo de visão 120</p>
                        </div>
