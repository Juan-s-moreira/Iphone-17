    ...
    return (
        <section className='bg-black py-20 px-6 '>
            <div className='max-w-5xl mx-auto text-center'>
                ...
                <p className='text-lg md:text-xl text-gray-300 mb-10 max-w-3xl mx-auto'>O design mais refinado que já criamos. Titânio de gray aerospacial. Chip A18 Pro. Sistema de câmera Pro revolucionário.</p>
            </div>
            <div className='flex flex-col md:flex-row gap-4 justify-center items-center mb-16 '>
                ...
                <button className='border-2 border-white rounded-full hover:bg-white hover:text-black text-white px-8 py-4 text-lg font-medium transition-all duration-600 hover:scale-105 cursor-pointer'>Saiba mais</button>
            </div>
